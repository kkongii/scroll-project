...
export const GameDetail = () => {
  ...
  const { data: game, isLoading, isError } = useReadContract({
      ...
      <CardContent className="grid gap-4">
        <Accordion type="multiple">
          <AccordionItem value="item-1 border-0">
            <AccordionTrigger className="text-black text-base text-[18px]">What we need to know (Event Info)</AccordionTrigger>
            <AccordionContent
              className="text-[#575757] bg-[#E5E5E5] shadow-inner p-6 border-0"
