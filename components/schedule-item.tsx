    ...
    <div key={game.gameId}>
      <Card className="my-4 w-96 w-full cursor-pointer hover:shadow-lg">
        ...
        <CardContent className="grid gap-4">
          <div className="flex flex-col text-lg font-bold text-muted-foreground text-white">
            <span>
        ...
        <CardFooter>
          <CardDescription>
            <div className="flex justify-between text-sm text-muted-foreground">
              ...
              <Button
                className="w-26 flex h-7 items-center bg-amber-400 font-semibold text-white"
                onClick={() =>
